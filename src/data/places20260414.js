export const PLACES = [
  ...
  },
  {
    ...
    description:
      "Ekuku Lake House offers a 10% discount on the total bill for Ahangama Card holders.",
    bestFor: ["Stay", "Lake House", "Discount"],
    tags: ["Stay", "Discount", "Lake House"],
    cardPerk: "10% off total bill with the Ahangama Card.",
    offer: ["10% Off"],
    howToClaim: "Show your Ahangama Card when booking to receive the discount.",
    restrictions:
    ...
    lng: 80.40254508650797,
    logo: "https://customer-apps-techhq.s3.eu-west-2.amazonaws.com/app-ahangama-demo/logos/eluku_lake_house.jpeg",
    image:
